          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">
                {actualOTJHours.toFixed(2)} / {totalOTJHours} hours
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">
                {actualOTJHours.toFixed(2)} / {expectedOTJHours} hours (
                {hoursPerWeekExpected}h/week)
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <span
                className={`font-semibold ${
                  hoursAheadOrBehind >= 0 ? 'text-green-600' : 'text-orange-600'
                }`}
              >
                {hoursAheadOrBehind >= 0 ? '+' : ''}
                {hoursAheadOrBehind.toFixed(2)}h{' '}
